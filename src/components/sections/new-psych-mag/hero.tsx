    ...
    <div className="container">
      <div className="pb-6 md:pb-10">
        ...
        <div className="mt-8 flex flex-col items-start md:mt-0 md:flex-row">
          ...
          <div className="mt-6 grid w-full shrink-0 grid-cols-2 gap-y-6 gap-x-6 md:mt-0 md:w-2/5 md:grid-cols-1 md:gap-x-0 md:gap-y-8 md:pt-32 lg:gap-y-10 lg:pt-40 xl:w-1/3">
