            ...
            <div className="w-full overflow-hidden text-white">
              <div className="container flex flex-col items-center">
                ...
                <p className="mt-4 md:mt-8 md:text-xl lg:text-2xl lg:leading-normal xl:max-w-4xl xl:text-3xl xl:leading-normal 2xl:max-w-5xl 2xl:text-[34px] 2xl:leading-normal">
                  ...
                  everything from specific lessons right through to new answers
                  to the most asked questions. We are constantly working to help
                  you improve, stay psyched and get more out of your surfing.
                  <br />
                  <br />
