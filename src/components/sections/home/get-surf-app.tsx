...
const GetSurfApp: React.FC<any> = ({blok}) => {
  return (
    ...
    >
      <div className="container flex flex-col items-center justify-center 2xl:space-y-32">
        <div className="text-center">
          <h3 className="font-accented text-3xl text-pink md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[70px]">
            Get Psyched
          </h3>
          <h2 className="mt-1 text-5xl leading-none text-white md:text-6xl lg:max-w-md lg:text-7xl xl:max-w-lg xl:text-8xl 2xl:max-w-4xl 2xl:text-[111px]">
