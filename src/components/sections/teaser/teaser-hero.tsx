...
>
              <div
                className="absolute w-full h-full pt-2 pr-4 pb-4"
              >
              <div
                className="w-full h-full overflow-hidden rounded-[75px]"
                style={{transform: 'translateZ(0)'}}
              >
                <VideoEmbed url="https://mytwyn-global.akamaized.net/877053fb-0352-40e7-a327-bb6563bcde36/877053fb-0352-40e7-a327-bb6563bc.ism/manifest(format=m3u8-aapl).m3u8" />
</div>
              </div>
       ...
       <div className="text-center">
         <h4 className="text-2xl text-white pt-12 pb-8">Scroll down to register for the sickest surf app</h4>
       </div>
    </section>
  )
}
