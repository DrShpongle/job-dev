  ...
  return (
    ...
    >
      <div className="container">
        ...
        <p className="mx-auto mt-8 max-w-6xl text-center md:text-xl lg:mt-10 lg:text-2xl lg:leading-normal xl:text-3xl xl:leading-normal 2xl:mt-12 2xl:text-[34px] 2xl:leading-normal">
